...
static_assert(sizeof(host_link_lens_profile_set_t) == 1, "host_link_lens_profile_set_t");
static_assert(sizeof(host_link_lens_profile_info_t) == 26, "host_link_lens_profile_info_t");
static_assert(sizeof(host_link_lens_relative_t) == 6, "host_link_lens_relative_t");
static_assert(sizeof(host_link_lens_dual_relative_t) == 12, "host_link_lens_dual_relative_t");
#endif
